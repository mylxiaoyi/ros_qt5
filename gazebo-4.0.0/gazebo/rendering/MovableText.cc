  ...
  for (i = this->text.begin(); i != this->text.end(); ++i)
  {
    ...
    *pVert++ = uvRect.top;
    ...
    else
    {
      ...
      maxSquaredRadius = std::max((Ogre::Real)maxSquaredRadius, currPos.squaredLength());
    }
...
//////////////////////////////////////////////////
Ogre::Real MovableText::getBoundingRadius() const
{
  boost::recursive_mutex::scoped_lock lock(*this->mutex);
  return this->radius;
}
...
//////////////////////////////////////////////////
Ogre::Real MovableText::getSquaredViewDepth(const Ogre::Camera * /*cam_*/) const
{
  boost::recursive_mutex::scoped_lock lock(*this->mutex);
  return 0;
}
